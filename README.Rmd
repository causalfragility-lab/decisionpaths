...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/decisionpaths)](https://CRAN.R-project.org/package=decisionpaths)
...
Paradigm** (Hait, 2025), which reconceptualises institutional AI systems not
as static classifiers but as infrastructure that generates time-ordered binary
decision sequences — the decision path — as the primary empirical object.
...
The package operationalises four infrastructure types defined in Hait (2025):
...
A simulation study with N = 200 students × K = 8 waves × 4 infrastructure
types (6,400 rows total, seed = 2025) confirms the theoretical predictions:
...
A companion Stata package `dpath` implementing the same paradigm is available
at: [https://github.com/causalfragility-lab/dpath](https://github.com/causalfragility-lab/dpath)
